package com.getgreetapp.greetapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.getgreetapp.greetapp.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.getgreetapp.greetapp.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
