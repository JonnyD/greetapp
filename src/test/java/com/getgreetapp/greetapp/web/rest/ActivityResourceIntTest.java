...
public class ActivityResourceIntTest {
    ...
    private static final String DEFAULT_ACTIVITY_COMPONENT = "AAAAAAAAAA";
    private static final String UPDATED_ACTIVITY_COMPONENT = "BBBBBBBBBB";
    ...
    public static Activity createEntity(EntityManager em) {
        Activity activity = new Activity()
            .type(DEFAULT_TYPE)
            .activityComponent(DEFAULT_ACTIVITY_COMPONENT)
    ...
    public void createActivity() throws Exception {
        ...
        assertThat(testActivity.getActivityComponent()).isEqualTo(DEFAULT_ACTIVITY_COMPONENT);
        assertThat(testActivity.getObjectId()).isEqualTo(DEFAULT_OBJECT_ID);
        assertThat(testActivity.getMessage()).isEqualTo(DEFAULT_MESSAGE);
    }
    ...
    @Test
    @Transactional
    public void checkActivityComponentIsRequired() throws Exception {
        int databaseSizeBeforeTest = activityRepository.findAll().size();
        // set the field null
        activity.setActivityComponent(null);
    ...
    public void getAllActivities() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].activityComponent").value(hasItem(DEFAULT_ACTIVITY_COMPONENT.toString())))
    ...
    public void getActivity() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities/{id}", activity.getId()))
            ...
            .andExpect(jsonPath("$.activityComponent").value(DEFAULT_ACTIVITY_COMPONENT.toString()))
    ...
    public void updateActivity() throws Exception {
        ...
        updatedActivity
            .type(UPDATED_TYPE)
            .activityComponent(UPDATED_ACTIVITY_COMPONENT)
        ...
        assertThat(testActivity.getActivityComponent()).isEqualTo(UPDATED_ACTIVITY_COMPONENT);
        assertThat(testActivity.getObjectId()).isEqualTo(UPDATED_OBJECT_ID);
        assertThat(testActivity.getMessage()).isEqualTo(UPDATED_MESSAGE);
    }
