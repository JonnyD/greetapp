...
describe('Service Tests', () => {
    describe('Friendship Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FriendshipService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/friendships';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Friendship', () => {
                service.create(new Friendship(null)).subscribe(received => {
            ...
            it('should update a Friendship', () => {
                service.update(new Friendship(123)).subscribe(received => {
